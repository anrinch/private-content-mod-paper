...
%
\figref{fig:dis_sign} shows the compute costs for signing and publishing the blocklist. We set the number of partitions $\numBlocklistParts$ such that each partition has at most 64 items. This  was fixed based on the time to verify a signature. Signing a blocklist with a million items takes roughly 170 seconds with up to 10 auditors
