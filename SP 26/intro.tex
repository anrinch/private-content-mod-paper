...
to detect harmful content in end-to-end encrypted photos uploaded to iCloud. The system, called the Apple PSI~\cite{bhowmick2021apple}, leveraged Apple' NeuralHash technology to generate a hash of the content. The hash is then compared privately against a blocklist curated by Apple. 
