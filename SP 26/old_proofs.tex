...
\end{gather*}
	...
	\begin{small}
				\begin{gather*}
				\prob{\hidingBlocklistExp = 1} \le 1/2 + \numBlocklistParts \left(\frac{\log \rsaMod}{\rsaMod}\right)
			\end{gather*}
		\end{small}
...
\end{gather*}
	...
	\begin{small}
				\begin{gather*}
				\prob{\hidingBlocklistExp = 1} \le 1/2  \\ + ~\numBlocklistParts \cdot \left(\frac{\log \rsaMod}{\rsaMod} + \Advantage{\indcpaRandLabel}{\encryptionSchemeDefn}(\timeBound, \oracleQueries)\right)
			\end{gather*}
		\end{small}
...
\end{gather*}
	...
	\begin{small}
				\begin{gather*}
				\prob{\hidingBlocklistExp = 1} \le 1/2  \\ + ~\numBlocklistParts \cdot \left(\frac{\log \rsaMod}{\rsaMod}\right) + 2 \blocklistSize (1 +  \cuckooTableParam)\Advantage{\indcpaRandLabel}{\encryptionSchemeDefn}(\timeBound, \oracleQueries)
			\end{gather*}
		\end{small}
