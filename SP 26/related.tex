...
\cline{2 - 9}
Fuzzy & {\bf This work} & \checkmark & M & SH & $\bigO(\blocklistSize^{\epsilon})$  & $\bigO(\blocklistSize^{\epsilon})$ & $\bigO(\blocklistSize^{1 + \epsilon})$ & \makecell{$\bigO(\blocklistSize^{\epsilon}  \genericVecLen)$}    \\ 
\cline{1-9}
\end{tabular}
\vspace{0.2em}
\end{table*}
